...
import tensorflow15 "github.com/tensorflow/tensorflow/tensorflow/go/core/framework"
...
func init() {
	proto.RegisterFile("tensorflow/core/protobuf/tensor_bundle.proto", fileDescriptorTensorBundle)
}
