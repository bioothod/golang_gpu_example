...
func (*NamedDevice) Descriptor() ([]byte, []int) { return fileDescriptorDeviceProperties, []int{1} }
...
func init() {
	proto.RegisterFile("tensorflow/core/protobuf/device_properties.proto", fileDescriptorDeviceProperties)
}
